...
export const dictionary: Record<string, Dictionary> = {
  ...
  hi: {
    ...
    landing: {
      ...
      scroll: 'नीचे जाएं',
      whyTitle: 'क्यों है KisanAlert खास?',
      ...
      ctaDesc: 'दूसरे किसानों और कृषि अधिकारियों के साथ जुड़ें जो KisanAlert से कीटों का पता लगाकर तुरंत कार्रवाई कर रहे हैं।',
    ...
    auth: {
      signInTitle: 'साइन इन',
      signInSubtitle: 'अपने KisanAlert डैशबोर्ड में जाएं',
      email: 'ईमेल',
      password: 'पासवर्ड',
      ...
      registerSubtitle: 'अपना KisanAlert खाता बनाएं',
    ...
    onboarding: {
      ...
      welcomeTitle: 'KisanAlert में आपका स्वागत है',
      ...
      step2Body: 'प्रभावित फसल की फोटो लेकर अपलोड करें। KisanAlert Gemini AI से सेकंडों में कीट या बीमारी की पहचान करता है, गंभीरता बताता है और प्रभावित फसल का अनुमान लगाता है।',
      ...
      finalBody: 'आप KisanAlert का इस्तेमाल शुरू करने के लिए तैयार हैं। पहले डैशबोर्ड देखें या AI जांच के लिए अपनी पहली फसल फोटो अपलोड करें।',
    },
    errors: {
  ...
  mr: {
    ...
    landing: {
      ...
      scroll: 'खाली सरकवा',
      whyTitle: 'KisanAlert का खास आहे?',
      ...
      ctaDesc: 'इतर शेतकरी आणि कृषी अधिकाऱ्यांसोबत जोडले जा जे KisanAlert वापरून कीड प्रादुर्भाव शोधून कारवाई करत आहेत.',
    ...
    auth: {
      signInTitle: 'साइन इन',
      signInSubtitle: 'तुमच्या KisanAlert डॅशबोर्डमध्ये प्रवेश करा',
      email: 'ईमेल',
      password: 'पासवर्ड',
      ...
      registerSubtitle: 'तुमचे KisanAlert खाते तयार करा',
    ...
    onboarding: {
      ...
      welcomeTitle: 'KisanAlert मध्ये आपले स्वागत आहे',
      ...
      step2Body: 'बाधित पिकाचा फोटो काढून अपलोड करा. KisanAlert Gemini AI वापरून सेकंदात कीड किंवा रोग ओळखतो, तीव्रता सांगतो आणि प्रभावित पिकाचा अंदाज लावतो.',
      ...
      finalBody: 'तुम्ही KisanAlert वापरण्यास सज्ज आहात. डॅशबोर्ड एक्सप्लोर करून सुरुवात करा किंवा AI विश्लेषणासाठी तुमचा पहिला पीक फोटो अपलोड करा.',
    },
    errors: {
  ...
  te: {
    ...
    landing: {
      ...
      whyTitle: 'KisanAlert ఎందుకు ప్రత్యేకం?',
      ...
      ctaDesc: 'KisanAlert ఉపయోగించి పురుగుల వ్యాప్తిని గుర్తించి స్పందించే రైతులు మరియు వ్యవసాయ అధికారులతో చేరండి.',
    ...
    auth: {
      ...
      signInSubtitle: 'మీ KisanAlert డాష్‌బోర్డ్‌ను యాక్సెస్ చేయండి',
      email: 'ఈమెయిల్',
      password: 'పాస్‌వర్డ్',
      ...
      registerSubtitle: 'మీ KisanAlert ఖాతాను సృష్టించండి',
    ...
    onboarding: {
      ...
      welcomeTitle: 'KisanAlertకు స్వాగతం',
      ...
      step2Body: 'చెడిపోయిన పంట ఫోటో తీసి అప్‌లోడ్ చేయండి. KisanAlert Gemini AI ఉపయోగించి సెకన్లలో పురుగు లేదా వ్యాధిని గుర్తించి, తీవ్రతను అంచనా వేసి, ప్రభావిత పంటను సూచిస్తుంది.',
      ...
      finalBody: 'మీరు KisanAlert ఉపయోగించడం ప్రారంభించడానికి సిద్ధంగా ఉన్నారు. మీ డాష్‌బోర్డ్‌ను అన్వేషించడం లేదా AI విశ్లేషణ కోసం మీ మొదటి పంట ఫోటోను అప్‌లోడ్ చేయడం ద్వారా ప్రారంభించండి.',
    },
    errors: {
  ...
  kn: {
    ...
    landing: {
      ...
      ctaDesc: 'KisanAlert ಬಳಸಿಕೊಂಡು ಕೀಟ ಹಾವಳಿಯನ್ನು ಪತ್ತೆಹಚ್ಚಿ ಪ್ರತಿಕ್ರಿಯಿಸುತ್ತಿರುವ ರೈತರು ಮತ್ತು ಕೃಷಿ ಅಧಿಕಾರಿಗಳೊಂದಿಗೆ ಸೇರಿ.',
    ...
    auth: {
      ...
      signInSubtitle: 'ನಿಮ್ಮ KisanAlert ಡ್ಯಾಶ್‌ಬೋರ್ಡ್ ಪ್ರವೇಶಿಸಿ',
      email: 'ಈಮೇಲ್',
      password: 'ಪಾಸ್‌ವರ್ಡ್',
      ...
      registerSubtitle: 'ನಿಮ್ಮ KisanAlert ಖಾತೆಯನ್ನು ರಚಿಸಿ',
    ...
    onboarding: {
      ...
      welcomeTitle: 'KisanAlert ಗೆ ಸುಸ್ವಾಗತ',
      ...
      step2Body: 'ಬಾಧಿತ ಬೆಳೆಯ ಫೋಟೋ ತೆಗೆದು ಅಪ್‌ಲೋಡ್ ಮಾಡಿ. KisanAlert Gemini AI ಬಳಸಿಕೊಂಡು ಸೆಕೆಂಡುಗಳಲ್ಲಿ ಕೀಟ ಅಥವಾ ರೋಗವನ್ನು ಗುರುತಿಸಿ, ತೀವ್ರತೆಯನ್ನು ಅಂದಾಜು ಮಾಡಿ, ಬಾಧಿತ ಬೆಳೆಯನ್ನು ಸೂಚಿಸುತ್ತದೆ.',
      ...
      finalBody: 'ನೀವು KisanAlert ಬಳಸಲು ಸಿದ್ಧರಾಗಿದ್ದೀರಿ. ನಿಮ್ಮ ಡ್ಯಾಶ್‌ಬೋರ್ಡ್ ಅನ್ನು ಅನ್ವೇಷಿಸುವ ಮೂಲಕ ಅಥವಾ AI ವಿಶ್ಲೇಷಣೆಗಾಗಿ ನಿಮ್ಮ ಮೊದಲ ಬೆಳೆ ಫೋಟೋ ಅಪ್‌ಲೋಡ್ ಮಾಡುವ ಮೂಲಕ ಪ್ರಾರಂಭಿಸಿ.',
    },
    errors: {
