...
function StepIndicator({
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#D1CCC3', color: '#6B6560' },
          active: { scale: 1, backgroundColor: '#E07A5F', color: '#E07A5F' },
          complete: { scale: 1, backgroundColor: '#4A5D23', color: '#4A5D23' },
        }}
...
function StepConnector({ isComplete }: { isComplete: boolean }) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: '#4A5D23' },
  }
